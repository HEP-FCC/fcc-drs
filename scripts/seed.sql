...
INSERT INTO dataset_requests
  (title, description, requester_name, requester_username, requester_email,
   assigned_group_id, dataset_type, use_case, status, priority,
...
('Higgs → bb̄ signal at FCC-ee √s=240 GeV',
 ...
 (SELECT id FROM coordinator_groups WHERE name = 'Higgs physics'), 'simulation', 'physics_analysis', 'in_progress', 'critical',
...
('$t\bar{t}$ production at FCC-hh 100 TeV',
 ...
 (SELECT id FROM coordinator_groups WHERE name = 'FCC-hh physics'), 'generation', 'physics_analysis', 'completed', 'high',
 '~5 TB', '50M events', '', '',
 'HepMC3', '2025-12-01',
...
('Drell-Yan background for LLP search',
 ...
 (SELECT id FROM coordinator_groups WHERE name = 'BSM physics'), 'simulation', 'physics_analysis', 'in_progress', 'high',
...
('Z-pole precision: $Z \to \mu\mu$ high-statistics sample',
 ...
 (SELECT id FROM coordinator_groups WHERE name = 'Electroweak physics'), 'simulation', 'physics_analysis', 'pending', 'critical',
 '~50 TB', '1B events', '', '',
 'EDM4hep', '2026-09-01',
...
('Tracker alignment sample: $e^+e^- \to \mu\mu$',
 ...
 (SELECT id FROM coordinator_groups WHERE name = 'Geometry, Simulation'), 'simulation', 'calibration', 'approved', 'medium',
...
('WW threshold scan: $e^+e^- \to W^+W^-$',
 ...
 (SELECT id FROM coordinator_groups WHERE name = 'Electroweak physics'), 'simulation', 'physics_analysis', 'pending', 'high',
...
('ECAL single-particle response: electrons 1–100 GeV',
 ...
 'Anna Kowalski', 'akowalski', 'akowalski@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'Geometry, Simulation'), 'simulation', 'calibration', 'completed', 'medium',
...
('Gluino pair production: $\tilde{g}\tilde{g} \to t\bar{t}\tilde{\chi}^0_1\tilde{\chi}^0_1$',
 ...
 'Li Chen', 'lchen', 'lchen@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'BSM physics'), 'generation', 'physics_analysis', 'pending', 'medium',
...
('ML training sample: jet flavour tagging',
 ...
 'Marco Rossi', 'mrossi', 'mrossi@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'High-level reconstruction'), 'reconstruction', 'ml_training', 'in_progress', 'high',
...
('Lepton flavour violation: $H \to e\mu$',
 ...
 'Sofia Fernandez', 'sfernandez', 'sfernandez@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'Higgs physics'), 'simulation', 'physics_analysis', 'draft', 'medium',
...
('PID benchmark: pions and kaons in RICH',
 ...
 'Hans Mueller', 'hmueller', 'hmueller@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'Geometry, Simulation'), 'simulation', 'benchmarking', 'completed', 'low',
...
('Inclusive $b\bar{b}$ at FCC-ee for B-physics',
 ...
 'Thomas Dupont', 'tdupont', 'tdupont@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'Flavour physics'), 'simulation', 'physics_analysis', 'rejected', 'medium',
 '~20 TB', '500M events', '', '',
 'EDM4hep', '2026-07-01',
...
('Single-top associated production at FCC-ee 365 GeV',
 ...
 'Anna Kowalski', 'akowalski', 'akowalski@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'Top-quark physics'), 'simulation', 'physics_analysis', 'draft', 'low',
 '~300 GB', '2M events', '', '',
 'EDM4hep', '2026-12-01',
...
('Track reconstruction benchmarking: $t\bar{t}$ at 365 GeV',
 ...
 'Marco Rossi', 'mrossi', 'mrossi@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'Digitization and Reconstruction Software'), 'reconstruction', 'reconstruction_development', 'in_progress', 'high',
...
('$H \to \gamma\gamma$ at FCC-ee 240 GeV',
 ...
 'Li Chen', 'lchen', 'lchen@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'Higgs physics'), 'simulation', 'physics_analysis', 'approved', 'high',
...
('Low-pT pile-up sample for FCC-hh: minimum bias',
 ...
 'Hans Mueller', 'hmueller', 'hmueller@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'MC Productions, GRID Tools'), 'generation', 'detector_simulation', 'completed', 'critical',
 '~200 TB', '10B events', '', '',
 'HepMC3', '2025-07-01',
...
('Dark photon: $A'' \to \ell^+\ell^-$ signal grid',
 ...
 'Sofia Fernandez', 'sfernandez', 'sfernandez@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'BSM physics'), 'generation', 'physics_analysis', 'draft', 'medium',
...
('HCAL tile response: single pions 5–150 GeV',
 ...
 'Thomas Dupont', 'tdupont', 'tdupont@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'Geometry, Simulation'), 'simulation', 'calibration', 'pending', 'medium',
...
('Flavour tagging validation: $D^0 \to K\pi$',
 ...
 'Marco Rossi', 'mrossi', 'mrossi@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'High-level reconstruction'), 'reconstruction', 'reconstruction_development', 'completed', 'low',
...
('Neutrino background for FCC-ee near detector',
 ...
 'Hans Mueller', 'hmueller', 'hmueller@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'Interaction Region, Beam Backgrounds'), 'simulation', 'detector_simulation', 'rejected', 'low',
 '~100 GB', '1M events', '', '',
 'ROOT', '2026-08-01',
...
('Top quark forward-backward asymmetry at 365 GeV',
 ...
 'Thomas Dupont', 'tdupont', 'tdupont@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'Top-quark physics'), 'simulation', 'physics_analysis', 'completed', 'medium',
...
('Fast-sim parametrisation training: ECAL',
 ...
 'Anna Kowalski', 'akowalski', 'akowalski@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'Geometry, Simulation'), 'simulation', 'ml_training', 'in_progress', 'high',
...
('Dijet QCD background for resonance searches',
 ...
 'Marco Rossi', 'mrossi', 'mrossi@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'QCD and photon-photon physics'), 'generation', 'physics_analysis', 'pending', 'medium',
...
('$e^+e^- \to \tau^+\tau^-$ at Z-pole',
 ...
 'Li Chen', 'lchen', 'lchen@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'Electroweak physics'), 'simulation', 'physics_analysis', 'draft', 'low',
 '~5 TB', '100M events', '', '',
 'EDM4hep', '2026-11-01',
...
('Vector boson scattering: $W^+W^-jj$ at FCC-hh',
 ...
 'Hans Mueller', 'hmueller', 'hmueller@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'Higgs physics'), 'generation', 'physics_analysis', 'cancelled', 'medium',
 '~4 TB', '50M events', '', '',
 'HepMC3', '2026-08-01',
...
('CLD vs. IDEA fast-sim benchmarking sample',
 ...
 'Sofia Fernandez', 'sfernandez', 'sfernandez@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'Geometry, Simulation'), 'delphes', 'benchmarking', 'pending', 'medium',
...
('High-mass $Z'' \to \ell\ell$ signal at FCC-hh',
 ...
 'Thomas Dupont', 'tdupont', 'tdupont@cern.ch',
 (SELECT id FROM coordinator_groups WHERE name = 'BSM physics'), 'generation', 'physics_analysis', 'pending', 'high',
